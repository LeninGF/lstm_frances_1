...
class VADModel(object):
  ...
  def evaluate(self,
    ...
    try:
      ...
      self.plot_predictions(_hard_predictions[1:400,:])
      print("Predictions plotted in plot folder")

      #self.plot_targets(Y_test[390000:398000,:])
      self.plot_targets(Y_test[1:400,:])
      print("Predictions plotted in plot folder")

      #self.plot_prediction_summary(predictions=_soft_predictions[390000:398000,:], ground_truth=Y_test[390000:398000,:])
      self.plot_prediction_summary(predictions=_soft_predictions[1:400,:],
                                   ground_truth=Y_test[1:400,:])
